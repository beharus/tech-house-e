  ...
  return (
    <section className="container py-6 pt-[180px]">
      <div className="grid lg:grid-cols-3 gap-6 items-stretch">
        {/* --- Main Slider (Unchanged) --- */}
        <div className="lg:col-span-2 relative rounded-2xl overflow-hidden aspect-[16/9] lg:aspect-[2/1] shadow-md group/slider">
        ...
        <div className="bg-gradient-to-br from-card to-card/90 rounded-2xl shadow-xl border border-border/40 overflow-hidden flex flex-col h-full min-h-[420px] lg:min-h-0">
          {/* Header */}
